...
export default function Gate({ onUnlock }: { onUnlock: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--adm-bg)] px-6">
      ...
      >
        <div className="mb-3 font-mono text-[0.68rem] uppercase tracking-widest text-[var(--adm-accent)]">
          ● profile editor
        </div>
        <h1 className="text-[26px] font-medium tracking-tight text-[var(--adm-ink)]">
          Sign in to edit.
        </h1>
        <p className="mt-3 text-sm leading-6 text-[var(--adm-muted)]">
          This page is for editing your portfolio content. Only you should have
          the credentials.
        </p>

        <label className="mt-6 block">
          <div className="mb-2 font-mono text-[0.62rem] uppercase tracking-widest text-[var(--adm-muted)]">
            Email
          </div>
          <input
            type="email"
        ...
        <button
          ...
          className="mt-6 w-full rounded-md bg-[var(--adm-ink)] px-4 py-3 font-mono text-[0.68rem] uppercase tracking-widest text-[var(--adm-bg)] transition disabled:cursor-not-allowed disabled:opacity-60"
        >
