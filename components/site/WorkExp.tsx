    ...
    <Section id="work">
      <Container className="space-y-10">
        ...
        <Surface className="overflow-hidden">
          <div className="hidden grid-cols-[5rem_minmax(0,1.4fr)_minmax(0,1fr)_6rem_5rem] gap-4 border-b border-[var(--color-rule-soft)] px-6 py-4 font-mono text-[0.62rem] tracking-widest text-[var(--color-muted)] lg:grid">
            <span>№</span>
            <span>Title</span>
          ...
          {filtered.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <span className="font-mono text-[0.62rem] tracking-widest text-[var(--color-muted)]">
                  {item.kind}
                </span>
          ...
          {experience.map((item, index) => (
            ...
            >
              ...
              <div>
                ...
                <p className="mt-2 font-mono text-xs tracking-wider text-[var(--color-accent)]">
                  {item.org}
                </p>
